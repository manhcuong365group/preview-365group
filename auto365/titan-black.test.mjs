...
assert.match(page, /id="faq"[\s\S]*?class="tb-faq__heading"[\s\S]*?Những điều chủ xe thường hỏi[\s\S]*?class="tb-faq"[\s\S]*?tb-faq__form[\s\S]*?tb-faq-list/, 'places the FAQ heading above both equal-height columns');
