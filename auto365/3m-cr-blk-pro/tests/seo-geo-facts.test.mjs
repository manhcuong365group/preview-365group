...
test('keeps the second CSS consolidation checkpoint at 12 style wrappers or fewer', () => {
...
test('keeps the fourth CSS consolidation checkpoint at 10 style wrappers or fewer', () => {
  assert.ok((html.match(/<style(?:\s[^>]*)?>/g) || []).length <= 10);
...
test('keeps the seventh CSS consolidation checkpoint at 7 style wrappers or fewer', () => {
