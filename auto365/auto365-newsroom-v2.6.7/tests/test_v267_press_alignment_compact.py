...
def test_press_each_column_owns_its_heading():
    ...
    assert 'class="press-column-heading">Bài nổi bật</h3>' in featured.group(1)
    ...
    assert 'class="press-column-heading">Nguồn khác</h3>' in secondary.group(1)
    assert 'press-columns-head' not in HTML
